        ...
        return (
            <preact.Fragment>
                {state.view === "connect"
                    ...
                    : <VideoPlayer />}
                {/* Stats + build pinned top-right, unaffected by scrolling. */}
                <div style={{ position: "fixed", right: "8px", top: "6px", fontSize: "11px", color: "rgba(255,255,255,0.65)", textAlign: "right", background: "rgba(0,0,0,0.45)", padding: "3px 8px", pointerEvents: "none", lineHeight: "1.5", maxWidth: "92vw", zIndex: 20 }}>
