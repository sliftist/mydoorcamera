...
function gapSuffix(): string { return state.gapMode !== "blank" ? `&gap=${state.gapMode}` : ""; }
...
function extraSuffix(): string { return lvlSuffix() + speedSuffix() + zoomSuffix() + acSuffix() + gapSuffix() + arSuffix() + atSuffix() + loopSuffix(); }
